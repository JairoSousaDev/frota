...
Route::group(['middleware' => 'admin'], function(){
    ...
    Route::group(['middleware' => 'auth'], function(){
        ...
        Route::get('/clientes/{codigo}', [\App\Http\Controllers\ClienteController::class, 'show'])->name('showCliente');
        ...
        Route::get('/autocomplete/cliente', [\App\Http\Controllers\VendaController::class, 'autocompleteCliente'])->name('autocompleteCliente');
        Route::get('/autocomplete/veiculo', [\App\Http\Controllers\VendaController::class, 'autocompleteVeiculo'])->name('autocompleteVeiculo');
        //
        //ENTRADAS CAIXA
        //
