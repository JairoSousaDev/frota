                ...
                <div class="form-row mt-4">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control form-control-sm" id="dataVenda" name="dataVenda" value="{{$venda->dataVenda}}">
                            @else
                            <input type="text" class="form-control form-control-sm" id="dataVenda" name="dataVenda" value="{{\Carbon\Carbon::parse($venda->dataVenda)->format('d/m/Y')}}">
                            @endif
                        </div>
                    </div>
                </div>
