        ...
        <table class="table table-bordered table-sm " id="tabelaSearch">
            <thead class="thead-dark">
              <tr class="table-dark">
                ...
                <th style="width: 40%"scope="col">Nome do Cliente</th>
                <th style="width: 33%"scope="col">Endereço</th>
              </tr>
            </thead>
            @if (session('error'))
            ...
            <tbody>
                ...
                <tr class="table-secondary">
                  <td class="table-secondary" scope="row">{{$cliente->id}}</td>
                  <td class="table-secondary">{{$cliente->codigoCliente}}</td>
